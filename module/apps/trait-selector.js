...
export default class TraitSelector extends HandlebarsApplicationMixin(DocumentSheetV2) {
  ...
  static DEFAULT_OPTIONS = {
    classes: ["exaltedsecond", "trait-selector", "subconfig"],
    tag: "form",
  ...
  static PARTS = {
    form: {
      template: "systems/exaltedsecond/templates/dialogues/trait-selector/trait-list.html",
    },
    footer: {
  ...
  get title() {
    return game.i18n.localize('Ex3.TraitSelection');
  }

  _initializeApplicationOptions(options) {
    options.classes = [options.document.getSheetBackground(), "exaltedsecond", "trait-selector", "subconfig"];
  ...
  async _prepareContext(_options) {
    ...
    return {
      ...
      custom: custom,
      buttons: [
        { type: "submit", icon: "fa-solid fa-save", label: "Ex3.Update", cssClass: "full-footer-button" }
      ],
    }
  }
